		...
		m = {
			...
			getDeviceConfig: function() {
				return navigator.userAgent.toLowerCase().indexOf("iphone") != -1 || navigator.userAgent.toLowerCase().indexOf("ipod") != -1 ? {
						...
						touch: true,
						zoom: 1
					} : navigator.userAgent.toLowerCase().indexOf("duopaowindowsphone") !=
					-1 ? {
						...
						touch: true,
						zoom: 1
					} : navigator.userAgent.toLowerCase().indexOf("symbian v3") !=
					-1 ? {
						device: "symbian3",
						fps: 1,
						touch: false,
				...
				if ((k = arguments[c]) != null)
					for (var q in k) {
						var n = b[q],
							o = k[q];
						if (b !== o)
							if (g && o && typeof o === "object" && !o.nodeType) b[q] = this.objExtend(g, n || (o.length != null ? [] : {}), o);
							else if (o !==
							undefined) b[q] = o
					}
				return b
		...
		classes: {
			...
			observer: function() {
				...
				this.register = function(b) {
					...
					jsGame.commandFuns.inArray(b, this.group) ==
						-1 && this.group.push(b);
					return this
				};
		...
		canvas: function() {
			...
			return {
				...
				drawRegion: function(e, h, i, j, l, t, r, s) {
					switch (t) {
						default: c.setTransform(1, 0, 0, 1, r, s);
						break;
				...
				drawNumber: function(e, h, i, j, l, t, r) {
					...
					if (r)
						for (e = 0; e < o.array.length; e++) b.drawImage(h,
							o.array[e] * i, 0, i, j, l + e * i, t, i, j);
					else
						for (e = o.array.length - 1; e >= 0; e--) b.drawImage(h, o.array[e] * i, 0, i, j, l - (o.array.length - 1 - e) * i, t, i, j, jsGame.graphics.ANCHOR_RT);
					return b
				},
				moveTo: function(e, h) {
					c.moveTo(e, h);
				...
				measureText: function(e) {
					...
					return {
						width: b.screen.getDevice() == "j2me" ? c.measureText(e) : i,
						height: h
					}
				},
		...
		initImage: function(b) {
			...
			if (b.length > 0) {
				...
				for (b = 0; b < a.image.imgObjs.length; b++)
					if (a.image.imgObjs[b].id != a.image.loadImgId) {
